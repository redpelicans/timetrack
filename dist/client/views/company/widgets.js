...
var _modelsCompaniesApp = require('../../models/companies-app');
...
var Edit = (0, _componentsAuthmanager.authable)(function (_ref, _ref2) {
  ...
  var handleChange = function handleChange(e) {
    e.preventDefault();
    _modelsNav.navActions.push(_routes2['default'].company.edit, { companyId: company.get('_id') });
  };
...
var Preferred = (0, _componentsAuthmanager.authable)(function (_ref3, _ref4) {
  ...
  var handleChange = function handleChange(e) {
    e.preventDefault();
    _modelsCompanies.companiesActions.togglePreferred(company);
  };
...
var Delete = (0, _componentsAuthmanager.authable)(function (_ref5, _ref6) {
  ...
  var handleChange = function handleChange(e) {
    ...
    if (answer) {
      _modelsCompanies.companiesActions['delete'](company.toJS());
...
var AddButton = (function (_Component) {
  ...
  function AddButton() {
    ...
    this.handleClick = function () {
      ...
      _modelsNav.navActions.push(_routes2['default'].company['new']);
    };
  }
    ...
    value: function render() {
      ...
      var tags = function tags() {
        var onClick = function onClick(tag, e) {
          e.preventDefault();
          var filter = '#' + tag + ' ';
          _modelsCompaniesApp.companiesAppActions.filter(filter);
          _modelsNav.navActions.push(_routes2['default'].company.list, { filter: filter });
        };
      ...
      var avatarView = function avatarView() {
        if (_this2.context.authManager.company.isAuthorized('view')) return _react2['default'].createElement(
          'a',
          { href: '#', onClick: _this2.handleView },
          avatar
