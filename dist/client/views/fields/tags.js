...
var _modelsTags = require('../../models/tags');
...
var TagField = (function (_BaseSelectField) {
  ...
  _createClass(TagField, [{
    ...
    value: function componentWillUnmount() {
      _get(Object.getPrototypeOf(TagField.prototype), 'componentWillUnmount', this).call(this);
    ...
    value: function componentWillMount() {
      ...
      this.unsubscribeTags = _modelsTags.tagsStore.listen(function (tags) {
        var domainValue = _lodash2['default'].map(tags.data.toJS(), function (tag) {
          return { key: tag, value: tag };
        });
        _this2.setState({ domainValue: domainValue });
      });
      _modelsTags.tagsActions.load();
    }
  }, {
    key: 'render',
