...
var Phone = function Phone(_ref) {
  var onDeleteField = _ref.onDeleteField;
  ...
  return _react2['default'].createElement(
    ...
    _react2['default'].createElement(
      ...
      _react2['default'].createElement(_fields.DropdownField, { field: field.field('label') })
    ),
    _react2['default'].createElement(
      'div',
      { style: styles.number, className: 'm-l-1' },
      _react2['default'].createElement(_fields.InputField, { field: field.field('number') })
    ),
    _react2['default'].createElement(
      'div',
      { style: styles['delete'] },
      _react2['default'].createElement(
        'a',
        { className: '', href: '#', onClick: onDeleteField.bind(null, field) },
...
Phone.propTypes = {
  field: _react.PropTypes.object.isRequired,
  onDeleteField: _react.PropTypes.func.isRequired
};
